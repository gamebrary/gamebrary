    ...
    <b-modal id="boardWallpaper" size="xl" scrollable hide-footer
      ...
      >
        <div>
          ...
          <MiniBoard class="mb-3" style="width: 400px; max-width: 100%" v-b-modal.boardWallpaper :board="board" />

          <b-form-checkbox v-if="board.type === $options.BOARD_TYPE_STANDARD" v-model="board.ranked" name="check-button"
            class="mb-3" switch>
            Ranked
          </b-form-checkbox>
          ...
          <div class="d-flex align-items-start">
            <v-swatches v-model="board.backgroundColor" show-fallback :trigger-style="{ height: '40px', width: '40px' }"
              popover-x="left" />
          ...
          <div v-if="board.type !== $options.BOARD_TYPE_STANDARD">
            <template v-if="board.type === 'tier'">
              ...
              <div v-for="(list, index) in lists" :key="index" class="d-flex justify-content-between align-items-start">
                <v-swatches v-model="list.backgroundColor" show-fallback
                  :trigger-style="{ height: '40px', width: '40px' }" popover-x="left" />
